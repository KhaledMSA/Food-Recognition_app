...
MediaType getImageMediaType(String path) {
  ...
  if (lowerPath.endsWith('.bmp')) return MediaType('image', 'bmp');
...
class ApiService {
  ...
  Future<MealEntry> saveManualMeal({
    ...
    final uri = Uri.parse('${ApiConfig.baseUrl}${ApiConfig.mealsManual}');
    ...
    try {
      ...
      throw ApiException('saveManualMeal failed: $e');
    }
  }
